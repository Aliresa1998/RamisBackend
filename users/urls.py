...
urlpatterns = [
     ...
     path('admin/status-ticket/<int:pk>/', AdminCloseTicketView.as_view(), name='admin-close/open-ticket'),
     ...
     path('admin-all-transaction/<int:pk>/', AdminAllTransactionView.as_view(),
